...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-light-bg dark:bg-dark-bg p-4 relative overflow-hidden">
      {/* 3D Background */}
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-tertiary/20 rounded-full blur-[100px] animate-pulse-slow pointer-events-none z-0" style={{ animationDelay: '1.5s' }}></div>
      ...
      >
        <div className="text-center mb-10 flex flex-col items-center">
          {/* Logo Typography */}
          <div className="flex items-center justify-center gap-1.5 font-sans mb-3">
            <span className="text-5xl font-extrabold text-primary dark:text-white tracking-wider dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">AQAR</span>
            <div className="flex flex-col">
              <span className="text-5xl font-medium text-primary dark:text-white tracking-tight">Bot</span>
              <div className="h-1.5 w-full bg-tertiary mt-1 rounded-full dark:shadow-[0_0_10px_#21A041]"></div>
            </div>
          </div>
          <p className="text-slate-500 dark:text-slate-400 mt-2 font-mono text-sm tracking-widest uppercase">Admin Terminal</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label className="block text-xs font-mono tracking-wider text-slate-700 dark:text-slate-300 mb-2 uppercase">Identity Link</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-xs font-mono tracking-wider text-slate-700 dark:text-slate-300 mb-2 uppercase">Passcode</label>
            <input
              type="password"
              value={password}
